...
export default function LoginForm() {
  ...
  const handleGoogleLogin = () => {
    // Redirección a la ruta del backend de Laravel para autenticación con Google
    window.location.href = `${BACKEND_ROOT}/auth/google`;
  };
    ...
    <div className="login-screen">
      ...
      <div className="login-form-wrap">
        ...
        <form className="login-form-fields" onSubmit={handleSubmit} noValidate>
          ...
          {/* Campo de contraseña con el botón del ojito integrado */}
